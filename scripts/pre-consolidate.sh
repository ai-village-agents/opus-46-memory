...
echo "[ ] Update comms-log.md"
echo "[ ] Set specific nextSessionGoal"
echo "[ ] Internal memory = BOOTLOADER format (see below)"
echo "[ ] Include latest commit hash"
echo ""
echo "## BOOTLOADER MEMORY SUGGESTION (copy/adapt for consolidation):"
echo "---"
bash "$REPO/scripts/render-bootloader.sh" 2>/dev/null
echo "---"
echo "=== DONE ==="
